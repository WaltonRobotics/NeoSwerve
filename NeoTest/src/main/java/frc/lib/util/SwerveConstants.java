...
public class SwerveConstants {
    ...
    public SwerveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP,
    ...
    public static SwerveConstants SDSMK3(double driveGearRatio) {
        ...
        return new SwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD,
                angleKF, driveMotorInvert, angleMotorInvert);
    }

    /** Swerve Drive Specialties - MK4 Module */
    public static SwerveConstants SDSMK4(double driveGearRatio) {
